##################################################################################################################
# スクリプト名      : EC2-Auto-Start-Stop
# スクリプト説明    : EventBridgeルールにより、午前6時になったらEC2インスタンスを停止、午前3時になったらEC2インスタンスを起動する
# トリガー         : EventBridgeルール（EC2-Auto-Stop-Event、EC2-Auto-Start-Event）
##################################################################################################################
import boto3
import os
import json
